...
<form action="/ccs/login.do" method="post">
	...
	<div class="form-floating">
	  <input type="text" class="form-control" name="m_id" id="m_id" placeholder="ID" style="width:300px">
	  <label for="floatingInput">&nbsp;아이디를 입력하세요.</label>
	</div>
	<div class="row md-2">
	<div class="form-floating">
	  <input type="password" class="form-control" name="m_pw" id="m_pw" maxlength=12 placeholder="Password" style="width:300px">
	...
	<div class="row" style="display: inline-block; margin-top:10px; margin-left:3px">		
			...
			<a href="/ccs/join.do">
			<input type="button" id="joinBtn" class="btn btn-success" value="회원가입" style="width:100px"></a>
	</div>
	</div>
	</div>
	</form>
